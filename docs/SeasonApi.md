...
|------------- | ------------- | -------------|
| [**getCalendar**](SeasonApi.md#getCalendar) | **GET** /{lang}/backend/api/v2/Calendar |  |
| [**getTyreSuppliers**](SeasonApi.md#getTyreSuppliers) | **GET** /{lang}/backend/api/v2/TyreSuppliers |  |



## getCalendar

> CalendarResponse getCalendar(lang, group)
...
import org.jlobato.gpro.api.SeasonApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CalendarResponse result = apiInstance.getCalendar(lang, group);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SeasonApi#getCalendar");
...
> TyreSuppliersResponse getTyreSuppliers(lang, season)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            TyreSuppliersResponse result = apiInstance.getTyreSuppliers(lang, season);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SeasonApi#getTyreSuppliers");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
[**TyreSuppliersResponse**](TyreSuppliersResponse.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Tyre Suppliers Response |  -  |
| **401** | Tyre Suppliers Error |  -  |
