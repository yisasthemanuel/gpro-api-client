...
|------------- | ------------- | -------------|
| [**getHistory**](HistoryApi.md#getHistory) | **GET** /{lang}/backend/api/v2/History |  |



## getHistory

> GetHistory200Response getHistory(lang, group, table, season)
...
import org.jlobato.gpro.api.HistoryApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        Table table = Table.fromValue("Standings"); // Table | History Section
        Integer season = 98; // Integer | Season Number
        try {
            GetHistory200Response result = apiInstance.getHistory(lang, group, table, season);
...
| **table** | [**Table**](.md)| History Section | [optional] [enum: Standings, ManResults, Calendar, CupStandings, TeamsStandings, TeamCupStandings, NationsKnockoutCup, Stats] |
