...
public class StaffApiTest {
    ...
    public void getAvailDriversTest()  {
        ...
        //OffRange offers = null;
        //WeiRange wei = null;
        //AvailDriversResponse response = api.getAvailDrivers(lang, page, minOA, maxOA, sort, sort2, sort3, agr, cha, con, mot, rep, sta, tal, tei, exp, age, minsal, offers, wei).block();
    ...
    public void getAvailTDsTest()  {
        ...
        //MinSalRange minsal = null;
        //OffRange offers = null;
        //AvailTDsResponse response = api.getAvailTDs(lang, page, minOA, maxOA, sort, aer, ele, lea, mec, mot, pit, exp, age, minsal, offers).block();
