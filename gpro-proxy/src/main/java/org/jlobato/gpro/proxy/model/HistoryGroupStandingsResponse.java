...
public class HistoryGroupStandingsResponse implements GetHistory200Response {
  ...
  public HistoryGroupStandingsResponse loadingDataState(@Nullable String loadingDataState) {
  ...
  public HistoryGroupStandingsResponse sections(List<@Valid History500OBRResponseSectionsInner> sections) {
  ...
  public HistoryGroupStandingsResponse group(@Nullable String group) {
    this.group = group;
    return this;
  }
  ...
  public HistoryGroupStandingsResponse requestedSeason(@Nullable Integer requestedSeason) {
  ...
  public HistoryGroupStandingsResponse season(@Nullable Integer season) {
    this.season = season;
    return this;
  }
  ...
  public HistoryGroupStandingsResponse title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public HistoryGroupStandingsResponse statsType(@Nullable String statsType) {
  ...
  public HistoryGroupStandingsResponse managers(List<@Valid HistoryGroupStandingsResponseManagersInner> managers) {
  ...
  public HistoryGroupStandingsResponse groups(List<@Valid CalendarResponseGroupsInner> groups) {
    this.groups = groups;
    return this;
  }
