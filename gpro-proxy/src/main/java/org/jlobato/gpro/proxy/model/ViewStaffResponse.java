...
import org.jlobato.gpro.proxy.model.ViewStaffResponseManagersInner;
...
public class ViewStaffResponse {
  ...
  @Valid
  private List<@Valid ViewStaffResponseManagersInner> managers = new ArrayList<>();
  ...
  public ViewStaffResponse loadingDataState(@Nullable String loadingDataState) {
  ...
  public ViewStaffResponse segmentSelected(@Nullable String segmentSelected) {
  ...
  public ViewStaffResponse group(@Nullable String group) {
    this.group = group;
    return this;
  }
  ...
  public ViewStaffResponse managers(List<@Valid ViewStaffResponseManagersInner> managers) {
  ...
  public List<@Valid ViewStaffResponseManagersInner> getManagers() {
    return managers;
  }

  public void setManagers(List<@Valid ViewStaffResponseManagersInner> managers) {
    this.managers = managers;
  }

  public ViewStaffResponse groups(List<@Valid CalendarResponseGroupsInner> groups) {
    this.groups = groups;
    return this;
  }
  ...
  public ViewStaffResponse apiRequestsRemaining(@Nullable Integer apiRequestsRemaining) {
